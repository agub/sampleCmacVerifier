 ...
 * ## Usage Example
 * ```typescript
 * import { verifyTag } from './cmacVerifier2';
 *
 * const result = verifyTag(
 *   '04E10C525C5A80',  // UID from NFC scan
 *   '00001A',          // Counter from NFC scan
 *   '8EE2F022BFADA6F5', // MAC from NFC scan
 *   '00000000000000000000000000000000' // Pre-shared AES key
 * );
 *
 * if (result.verified) {
